...
# # mycursor.execute('DELETE from game')
...
#     game['date_start'] = game['date_start'].replace('T', ' ')[:-6]
...
#         continue
#
#     mycursor.execute("INSERT INTO game(game_id, date_start, game_number, week, season, attendance, game_duration, \
#                                         event_type_id, event_status_id, venue_id, team_1_team_id, team_2_team_id) \
#                                         VALUES(%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
#                      (game['game_id'], game['date_start'], game['game_number'], game['week'], game['season'],
#                       game['attendance'], game['game_duration'], game['event_type']['event_type_id'],
#                       game['event_status']['event_status_id'], game['venue']['venue_id'],
#                       game['team_1']['team_id'], game['team_2']['team_id']))
